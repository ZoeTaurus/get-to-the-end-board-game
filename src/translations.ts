...
export const translations: Record<string, Translation> = {
  English: {
    ...
    bots: {
      ...
      wizardDescription: 'PERFECT AI - Anticipates moves, defends strategically, captures safely',
      ...
      forMasterPlayers: 'Ultimate challenge - Only for the bravest!'
    },
    navigation: {
      home: 'Home',
      bots: 'Bots',
  ...
  Spanish: {
    ...
    bots: {
      ...
      wizardDescription: 'IA PERFECTA - Anticipa movimientos, defiende estratégicamente, captura con seguridad',
      ...
      forMasterPlayers: 'Desafío supremo - ¡Solo para los más valientes!'
    },
    navigation: {
      home: 'Inicio',
      bots: 'Bots',
